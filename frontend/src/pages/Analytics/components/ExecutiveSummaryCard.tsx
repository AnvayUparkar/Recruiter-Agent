...
export const ExecutiveSummaryCard: React.FC<ExecutiveSummaryCardProps> = ({
  ...
  return (
    <motion.div
      ...
      className="glass-panel p-6 rounded-2xl border-l-4 border-l-purple-500 bg-gradient-to-r from-purple-500/10 to-indigo-600/5 dark:from-purple-500/20 dark:to-indigo-600/10 shadow-xl mb-6 relative overflow-hidden group"
    >
      ...
      <div className="flex gap-4 items-start relative z-10">
        ...
        <div className="flex-1 flex flex-col gap-1.5">
          ...
          <p className="text-xs text-text-primary/90 leading-relaxed font-sans mt-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mt-4 text-[11px]">
            <div className="flex items-start gap-2 text-text-muted bg-surface/50 p-2.5 rounded-lg border border-border">
              <CheckCircle2 size={14} className="text-emerald-500 dark:text-emerald-400 shrink-0 mt-0.5" />
              <div>
                <strong className="text-text-primary block font-heading">Technical Depth</strong>
                Candidate pools are exceptionally strong in required core skills.
              </div>
            </div>

            <div className="flex items-start gap-2 text-text-muted bg-surface/50 p-2.5 rounded-lg border border-border">
              <TrendingUp size={14} className="text-blue-500 dark:text-blue-400 shrink-0 mt-0.5" />
              <div>
                <strong className="text-text-primary block font-heading">High Verdict Ratio</strong>
            ...
            <div className="flex items-start gap-2 text-text-muted bg-surface/50 p-2.5 rounded-lg border border-border">
              ...
              <div>
                <strong className="text-text-primary block font-heading">Leadership Exposure</strong>
