    ...
    <div className="w-full glass-panel rounded-2xl border-white/10 shadow-xl p-5 md:p-6 mb-6">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-1.5">
          <span className="text-[10px] text-slate-500 font-bold uppercase tracking-wider">Report Format</span>
          <select
            value={reportType}
            onChange={(e) => setReportType(e.target.value)}
            className="w-full p-2.5 rounded-xl bg-black/40 border border-white/10 text-white text-xs outline-none focus:border-blue-500"
          >
        ...
        {reportType === "dossier" && (
          <div className="flex flex-col gap-1.5">
            <span className="text-[10px] text-slate-500 font-bold uppercase tracking-wider">Candidate</span>
            <select
        ...
        <div className="pt-2">
          ...
          {/* Progress Indicator */}
          {isGenerating && (
            <div className="flex flex-col gap-2 p-3.5 rounded-xl bg-white/2 border border-white/5">
