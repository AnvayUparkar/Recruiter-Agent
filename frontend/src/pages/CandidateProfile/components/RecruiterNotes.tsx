    ...
    >
      ...
      <div className="px-6 pt-6 pb-4 border-b border-white/6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="flex items-center gap-1 px-2.5 py-1 rounded-lg border border-white/8 bg-white/4 hover:bg-white/8 text-[11px] font-semibold text-slate-400 hover:text-slate-200 transition-all"
          ...
          {notes.length > 0 && (
            <button
              onClick={handleClear}
              className="flex items-center gap-1 px-2.5 py-1 rounded-lg border border-rose-500/20 bg-rose-500/8 hover:bg-rose-500/15 text-[11px] font-semibold text-rose-400 transition-all"
      ...
      <div className="p-6 flex flex-col gap-2">
        <textarea
          ...
          className="w-full min-h-[180px] bg-white/2 border border-white/6 rounded-xl p-4 text-sm text-slate-300 placeholder-slate-600 resize-y focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-blue-500/30 transition-colors leading-relaxed font-sans"
          spellCheck
        />
