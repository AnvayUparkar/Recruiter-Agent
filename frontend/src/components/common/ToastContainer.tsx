...
export const ToastContainer: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 md:left-auto md:bottom-6 md:right-6 z-[9999] flex flex-col gap-3.5 w-auto md:w-full md:max-w-sm pointer-events-none select-none">
      <AnimatePresence>
